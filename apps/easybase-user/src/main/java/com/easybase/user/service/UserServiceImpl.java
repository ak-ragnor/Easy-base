...
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    public UserServiceImpl(UserRepository repository, CollectionService collectionService, SyncService syncService) {
...
// Save the updated entity
    ...
    public Page<UserResponseDTO> search(String search, String filter, String sort, Pageable pageable) {
        return collectionService.search("eb_user", search, filter, sort, pageable).map(this::convertToResponseDTO);
    }
