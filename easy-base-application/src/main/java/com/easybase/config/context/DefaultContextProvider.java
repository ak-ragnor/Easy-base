...
import com.easybase.common.api.context.CorrelationIds;
import com.easybase.common.api.context.ServiceContext;
import com.easybase.common.api.context.TenantInfo;
...
import com.easybase.common.data.context.ServiceContextImpl;
...
public class DefaultContextProvider implements ContextProvider {
	...
	public ServiceContext build(HttpServletRequest request) {
		...
		try {
			authResult = _authenticationService._authenticate(request);
		}
