...
public final class HttpErrorHandler {
	 ...
	 *
	 * @param response the HTTP response to configure
	 * @param expiredTokenException the expired token exception
	 * @throws IOException if response writing fails
	 */
	public static void handleExpiredToken(
		...
		log.debug("Token expired: {}", expiredTokenException.getMessage());
	 ...
	 *
	 * @param response the HTTP response to configure
	 * @param invalidTokenException the invalid token exception
	 * @throws IOException if response writing fails
	 */
